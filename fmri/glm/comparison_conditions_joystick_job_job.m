%-----------------------------------------------------------------------
% Job saved on 08-Jun-2022 11:14:44 by cfg_util (rev $Rev: 7345 $)
% spm SPM - SPM12 (7771)
% cfg_basicio BasicIO - Unknown
%-----------------------------------------------------------------------
matlabbatch{1}.spm.stats.factorial_design.dir = {'C:\Users\davide\Documents\GitHub\raindrop_analyses_fmri_eeg\fmri'};
matlabbatch{1}.spm.stats.factorial_design.des.fd.fact(1).name = 'Polarity';
...
matlabbatch{1}.spm.stats.factorial_design.des.fd.fact(2).name = 'Day';
...
matlabbatch{1}.spm.stats.factorial_design.des.fd.fact(3).name = 'Time';
