...
matlabbatch{2}.spm.stats.fmri_spec.sess.cond.name = 'tennis';
matlabbatch{2}.spm.stats.fmri_spec.sess.cond.onset = '<UNDEFINED>';
matlabbatch{2}.spm.stats.fmri_spec.sess.cond.duration = 31; % specific for the tennis task (GREEK!)
...
matlabbatch{4}.spm.stats.con.consess{2}.tcon.name = 'tennis > relax';
